...
const OrganizationManagement = () => {
    const books = pdfFiles.filter(
        (book) => book.type === 'ORGANIZATION MANAGEMENT'
    );
                ...
                <div className="bis-content">
                    ...
                    <div className="bis-info">
                        ...
                        <div className="bis-info-card">
                            ...
                            <p>
                                Learn about organizational structures,
                                management principles, and business operations.
                            </p>
                        </div>
                        ...
                        <div className="bis-info-card">
                            ...
                            <p>
                                Explore leadership, teamwork, motivation,
